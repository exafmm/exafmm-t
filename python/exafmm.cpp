...
PYBIND11_MODULE(exafmm, m) {
  ...
  py::class_<Node<real_t>>(m0, "Node")
     ...
     .def_readwrite("up_equiv", &Node<real_t>::up_equiv)
     .def_readwrite("dn_equiv", &Node<real_t>::dn_equiv)
  ...
  py::class_<Node<complex_t>>(m1, "Node")
     ...
     .def_readwrite("up_equiv", &Node<complex_t>::up_equiv)
     .def_readwrite("dn_equiv", &Node<complex_t>::dn_equiv)
