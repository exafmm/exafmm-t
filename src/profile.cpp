      ...
      if(e_log[i]) {
        ...
        if(!rank) {
          ...
          if(n_log[i] == "P2M" || n_log[i] == "M2M" || n_log[i] == "P2L"
             ...
             || n_log[i] == "Total" || n_log[i] == "vec to array" || n_log[i] == "host to device" || n_log[i] == "gpu kernel" || n_log[i] == "device to host" || n_log[i] == "array to vec" || n_log[i] == "FFT_UpEquiv" || n_log[i] == "hadamard" || n_log[i] == "FFT_Check2Equiv" || n_log[i] == "general")
